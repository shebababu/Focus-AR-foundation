...
public class SceneLoaderSecond : MonoBehaviour
{
    ...
    private string text_one= "In this scene you can see two 3D models of jet engine, Go closer to the 3d model to get more information.If you want to go to previous scene, walk towards left from the left Jet engine. If you want to go to next scene, walk towards right from the right 3d object.";
    ...
    void Start()
    {
        ...
        SetInstructionText("In this scene you can see the jet engine without nozzles and a 3D model of Industrial Robotic Arm. Go closer to the 3d model to get more information. If you want to go to previous scene, walk towards left from the left Jet engine. If you want to go to next scene, walk towards right from the right 3d object.");
